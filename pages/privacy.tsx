        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-10 shadow-sm">
          ...
          <section className="mt-10 space-y-5 text-slate-700">
            ...
            <div>
              ...
              <p className="mt-3 leading-7">
                If you have privacy questions, email <a href="mailto:hello@jgdev.co.uk" className="text-primary-600 hover:text-primary-700">hello@jgdev.co.uk</a> or submit a message through our <Link href="/contact" className="text-primary-600 hover:text-primary-700">contact page</Link>.
              </p>
            </div>
          </section>
        </div>
